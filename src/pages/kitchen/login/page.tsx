...
export default function KitchenLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-background-50 flex items-center justify-center p-4 relative overflow-hidden">
      <FloatingFood />
      <KitchenSmoke />
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <div className="w-14 h-14 mx-auto mb-4 rounded-xl bg-primary-500 flex items-center justify-center">
            <i className="ri-fire-line text-2xl text-background-50"></i>
          </div>
          <h1 className="font-heading text-2xl font-semibold text-foreground-900">Kitchen Login</h1>
          <p className="text-sm text-foreground-500 mt-1">Sign in to view the order queue</p>
        </div>
